...
describe('LazyBoyAsync', () => {
    ...
    describe('Attachments', () => {
        ...
        it('Should push an attachment', () => __awaiter(this, void 0, void 0, function* () {
            ...
            let doc = yield l.AddFileAsAttachmentAsync(dbName, insert.entry._id, insert.entry._rev, "vortex", path.join(__dirname, '../../test/vortex.jpg'));
        ...
        it('Should update the attachment', () => __awaiter(this, void 0, void 0, function* () {
            ...
            let doc = yield l.AddFileAsAttachmentAsync(dbName, insert.entry._id, test.data._rev, "vortex", path.join(__dirname, '../../test/android.jpg'));
            expect(doc.error).to.equal(null);
            expect(doc.status.ok).to.equal(true);
