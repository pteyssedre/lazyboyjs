...
describe('LazyBoy', function () {
    ...
    describe('AutoConnect false', function () {
        it('Should not connect if autoConnect is set to false', function () {
            let l = new lazyboyjs.LazyBoy({autoConnect: false, cache:true, raw:false, forceSave:true});
...
describe('LazyBoyAsync', () => {
    ...
    describe('Attachments', () => {
        ...
        it('Should push an attachment', async() => {
            ...
            let doc = await l.AddFileAsAttachmentAsync(dbName, insert.entry._id, insert.entry._rev, "vortex", path.join(__dirname, '../../test/vortex.jpg'));
        ...
        it('Should retrieve attachment info', async() => {
            ...
            expect(info.content_type).equal(mime.lookup(path.join(__dirname, '../../test/vortex.jpg')));
            let stats = fs.statSync(path.join(__dirname, '../../test/vortex.jpg'));
        ...
        it('Should update the attachment', async() => {
            ...
            let sourcePathVortex = path.join(__dirname, '../../test/vortex.jpg');
            let sourcePathAndroid = path.join(__dirname, '../../test/android.jpg');
            ...
            let doc = await l.AddFileAsAttachmentAsync(dbName, insert.entry._id, test.data._rev, "vortex", path.join(__dirname, '../../test/android.jpg'));
